package farmers.tech.waitingbee.Widgets;
...
/**
 * Created by GauthamVejandla on 9/10/16.
 */
public class TextChronometer extends TextView {

    private boolean isAttached;
    private long time;
    private ChronometerDateRenderer dateRenderer;
    ...
    private void init(Context context) {
        dateRenderer = new ChronometerDateRenderer(context);
        hasSeconds = true;
        handler = new Handler();
    }
    ...
    private void onTimeChanged() {
        ChronometerDateRenderer.TimeAgo timeAgo = dateRenderer.timeAgo(time);
        hasSeconds = timeAgo.unit.type.equals(ChronometerDateRenderer.SECONDS);
        setupTicker();
